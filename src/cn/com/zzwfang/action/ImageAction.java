...
public final class ImageAction {
    ...
    public static void init(Context conetxt) {
        ...
        ImageLoaderConfiguration.Builder builder = new ImageLoaderConfiguration.Builder(conetxt);
        builder.memoryCacheExtraOptions(screenTools.getScreenWidth(), screenTools.getScreenHeight());
    ...
    private static void initOptions(Context conetxt) {
        ...
        DIP_IMAGE = new DisplayImageOptions.Builder()
                    .showImageOnLoading(ResLoader.loadDrawable(conetxt, R.drawable.color_image_bg))
                    .showImageForEmptyUri(ResLoader.loadDrawable(conetxt, R.drawable.color_image_bg))
                    .showImageOnFail(ResLoader.loadDrawable(conetxt, R.drawable.color_image_bg))
                    .resetViewBeforeLoading(false)
                    .bitmapConfig(Config.RGB_565)
                    .cacheInMemory(true)
                    .cacheOnDisk(true)
    ...
    public static void displayImage(String uri, ImageView imageView, ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
        loader.displayImage(uri, imageView, DIP_IMAGE_PRO, listener, progressListener);
    }
    
    public static void displayImage(String uri, ImageAware imageAware, ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
        loader.displayImage(uri, imageAware, DIP_IMAGE_PRO, listener, progressListener);
    }
    
    private ImageAction(){}
    
    public static class AbsListViewPauseOnScrollListenerProxy implements AbsListView.OnScrollListener {
        ...
        public AbsListViewPauseOnScrollListenerProxy(ImageLoader imageLoader, boolean pauseOnScroll, boolean pauseOnFling) {
