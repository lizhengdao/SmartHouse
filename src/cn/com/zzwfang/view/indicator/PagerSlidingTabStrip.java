...
package cn.com.zzwfang.view.indicator;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private static final int[] ATTRS = new int[] { android.R.attr.textSize,
            android.R.attr.textColor, android.R.attr.textColor };
    // @formatter:on
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs,
        ...
        tabUnselectedTextColor = a.getColor(2, tabUnselectedTextColor);
        ...
        dividerPadding = a
                .getDimensionPixelSize(
                        R.styleable.PagerSlidingTabStrip_dividerPaddingPagerSlidingTabStrip,
                        dividerPadding);
        ...
        textAllCaps = a.getBoolean(
                R.styleable.PagerSlidingTabStrip_textAllCapsPagerSlidingTabStrip, textAllCaps);
