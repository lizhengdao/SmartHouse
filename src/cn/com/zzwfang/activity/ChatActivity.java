...
public class ChatActivity extends BaseActivity implements OnClickListener,
    ...
    public static final String INTENT_MSG_POSITION = "intent_msg_position";
    ...
    protected void onCreate(Bundle arg0) {
        ...
        historyMsgs = (ArrayList<MessageBean>) intent
                .getSerializableExtra(INTENT_HISTORY_MSG);
        position = intent.getIntExtra(INTENT_MSG_POSITION, -1);
    ...
    private void sendMessage() {
        ...
        actionImpl.sendMessage(userId, messageTo, message,
    ...
    private void getHistoryMsg(String contactId) {
        ...
        actionImpl.getMessageRecordsWithSomeBody(contactId,
                new ResultHandlerCallback() {
                    ...
                    @Override
                    public void rc0(RequestEntity entity, Result result) {
                        ArrayList<IMContactBean> contactBeans = (ArrayList<IMContactBean>) JSON
    ...
    private void readMessage(final ArrayList<MessageBean> contactMessages) {
        ...
        actionImpl.readMessage(ids, new ResultHandlerCallback() {
            ...
            public void rc0(RequestEntity entity, Result result) {
                ...
                MessagePool.setReadStateTrue(position);
